...
const TEMPLATES = {
  products: {
    ...
    columns: [
      ...
      { header: 'GTIN',                     hint: 'Digits only — 8, 12, 13 or 14 digits (optional)',                        example: '04012345678901' },
      ...
      { header: 'Durability Score',         hint: '0–10 in 0.5 steps, e.g. 8.5 (optional)',                                 example: '8.5' },
      { header: 'Repairability Score',      hint: '0–10 in 0.5 steps, e.g. 7 (optional)',                                   example: '7' },
  ...
  variants: {
    ...
    columns: [
      ...
      { header: 'Size',           hint: 'Pick from the list: "Women"/"Men" + EU size, e.g. Women 34, Men 48, or One size (optional)', example: 'Women 38' },
      { header: 'GTIN',           hint: 'Digits only — 8, 12, 13 or 14 digits (optional)', example: '04012345678902' },
