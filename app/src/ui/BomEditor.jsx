...
import { Trash2, Pencil, ExternalLink, Plus, SaveAll } from 'lucide-react';
...
const COLS =
  'grid-cols-[180px_minmax(0,3fr)_180px_90px_80px_minmax(0,2fr)_110px]';
            ...
            {draftRows.map((r) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className="min-w-0 border-r border-black/10 py-3 pr-3 text-sm font-medium text-ink"
                    style={{ paddingLeft: `${12 + r.__depth * 24}px` }}
                  >
